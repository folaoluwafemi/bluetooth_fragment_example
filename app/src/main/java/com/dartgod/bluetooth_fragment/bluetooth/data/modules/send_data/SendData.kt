...
typealias ReceiveDataListener = (ByteArray) -> Unit
...
//    override fun receiveData(receiveListener: ReceiveDataListener) {
////        val buffer = ByteArray(1024)
////        val bytes: Int = bluetoothSocket.inputStream.read(buffer)
////        receiveListener(buffer.copyOfRange(0, bytes))
//    }
